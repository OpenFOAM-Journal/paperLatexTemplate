...
\renewcommand{\thefootnote}{\fnsymbol{footnote}}%footnote for corresponding author
\newcommand{\corrauthor}[1]{\author{\underline{#1}}\footnote[1]{Corresponding author}}%command for corresponding author
...
%\corrauthor{M. Jersey$^1$}
%\address{$^1$Address1}
%\email{Emailaddress1}

%    Author two information
%\author{J. Smith$^1$}
%%\address{$^1$Address1} % not needed if the same as author 1
%\email{Emailaddress1}
...
\renewcommand{\thefootnote}{\arabic{footnote}}%go back to normal footnote style
\setcounter{footnote}{0}%also reset footnote counter
